...
UPDATE `trainer_locale` SET `Greeting_lang` = "Hallo, $gJäger!:Jägerin!; Bereit für etwas Training?" WHERE `locale`='deDE' AND `Id`=7; 
UPDATE `trainer_locale` SET `Greeting_lang` = "Hallo, $gJäger!:Jägerin!; Bereit für etwas Training?" WHERE `locale`='deDE' AND `Id`=8; 
UPDATE `trainer_locale` SET `Greeting_lang` = "Hallo, $gSchurke!:Schurkin!; Bereit für etwas Training?" WHERE `locale`='deDE' AND `Id`=9; 
UPDATE `trainer_locale` SET `Greeting_lang` = "Hallo, $gSchurke!:Schurkin!; Bereit für etwas Training?" WHERE `locale`='deDE' AND `Id`=10; 
UPDATE `trainer_locale` SET `Greeting_lang` = "Hallo, $gPriester!:Priesterin!; Bereit für etwas Training?" WHERE `locale`='deDE' AND `Id`=11; 
